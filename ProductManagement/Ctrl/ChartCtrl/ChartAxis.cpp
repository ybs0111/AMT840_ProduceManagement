						  ...
						  double dTickVal)
{
	...
	if (m_bIsHorizontal)
	{
		...
		if (!m_bIsSecondary)
		{
			...
			if (bLabelOnAxis)
			{
				if (strBuffer == _T("0")) strBuffer = _T("22");
				else if (strBuffer == _T("1")) strBuffer = _T("23");
				else if (strBuffer == _T("2")) strBuffer = _T("24");
				else if (strBuffer == _T("3")) strBuffer = _T("1");
				else if (strBuffer == _T("4")) strBuffer = _T("2");
				else if (strBuffer == _T("5")) strBuffer = _T("3");
				else if (strBuffer == _T("6")) strBuffer = _T("4");
				else if (strBuffer == _T("7")) strBuffer = _T("5");
				else if (strBuffer == _T("8")) strBuffer = _T("6");
				else if (strBuffer == _T("9")) strBuffer = _T("7");
				else if (strBuffer == _T("10")) strBuffer = _T("8");
				else if (strBuffer == _T("11")) strBuffer = _T("9");
				else if (strBuffer == _T("12")) strBuffer = _T("10");
				else if (strBuffer == _T("13")) strBuffer = _T("11");
				else if (strBuffer == _T("14")) strBuffer = _T("12");
				else if (strBuffer == _T("15")) strBuffer = _T("13");
				else if (strBuffer == _T("16")) strBuffer = _T("14");
				else if (strBuffer == _T("17")) strBuffer = _T("15");
				else if (strBuffer == _T("18")) strBuffer = _T("16");
				else if (strBuffer == _T("19")) strBuffer = _T("17");
				else if (strBuffer == _T("20")) strBuffer = _T("18");
				else if (strBuffer == _T("21")) strBuffer = _T("19");
				else if (strBuffer == _T("22")) strBuffer = _T("20");
				else if (strBuffer == _T("23")) strBuffer = _T("21");
				else if (strBuffer == _T("24")) strBuffer = _T("22");
	...
	else
	{
		...
		do 
		{
			if (IsLabelOnAxis(TickValue))
			{
				...
				if (strLabel == _T("0")) strLabel = _T("22");
				else if (strLabel == _T("1")) strLabel = _T("23");
				else if (strLabel == _T("2")) strLabel = _T("24");
				else if (strLabel == _T("3")) strLabel = _T("1");
				else if (strLabel == _T("4")) strLabel = _T("2");
				else if (strLabel == _T("5")) strLabel = _T("3");
				else if (strLabel == _T("6")) strLabel = _T("4");
				else if (strLabel == _T("7")) strLabel = _T("5");
				else if (strLabel == _T("8")) strLabel = _T("6");
				else if (strLabel == _T("9")) strLabel = _T("7");
				else if (strLabel == _T("10")) strLabel = _T("8");
				else if (strLabel == _T("11")) strLabel = _T("9");
				else if (strLabel == _T("12")) strLabel = _T("10");
				else if (strLabel == _T("13")) strLabel = _T("11");
				else if (strLabel == _T("14")) strLabel = _T("12");
				else if (strLabel == _T("15")) strLabel = _T("13");
				else if (strLabel == _T("16")) strLabel = _T("14");
				else if (strLabel == _T("17")) strLabel = _T("15");
				else if (strLabel == _T("18")) strLabel = _T("16");
				else if (strLabel == _T("19")) strLabel = _T("17");
				else if (strLabel == _T("20")) strLabel = _T("18");
				else if (strLabel == _T("21")) strLabel = _T("19");
				else if (strLabel == _T("22")) strLabel = _T("20");
				else if (strLabel == _T("23")) strLabel = _T("21");
				else if (strLabel == _T("24")) strLabel = _T("22");
