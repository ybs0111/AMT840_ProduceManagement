...
{
public:
	void			ReadWork(COleDateTime tDate);
	void			WriteWork(CString *strData);
	void			ReadCycle(COleDateTime tDate);
...
public:
	...
	BOOL ReadFile1(int nNum, CString strFileName);
	BOOL WriteFile(int nNum, CString strFileName);
	BOOL WriteFile1(int nNum, CString strFileName);
